...
#plot1
plot(part_data_na$Global_active_power ~ part_data_na$Combined, lty =1, lwd =1, type = "l", xlab ="", ylab = "Global Active Power")

#plot2
plot(part_data_na$Voltage ~ part_data_na$Combined, lty =1, lwd =1, type = "l", xlab ="datetime", ylab = "Voltage")
...
#plot4
plot(part_data_na$Global_reactive_power ~ part_data_na$Combined, lty =1, lwd =1, type = "l", xlab ="datetime", ylab = "Global_reactive_power")
